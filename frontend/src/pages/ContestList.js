    ...
    <div className="min-h-screen bg-gray-100">
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-gray-900">Online Contest Platform</h1>
          <nav className="mt-4">
            <Link to="/login" className="text-purple-600 hover:text-purple-800">Login</Link>
            <Link to="/leaderboard" className="ml-4 text-purple-600 hover:text-purple-800">Leaderboard</Link>
          </nav>
        </div>
      </header>
